			...
			<div id="col1" class="col-xs-12">
				...
				<div class="col-sm-9">
			        <ul class="nav nav-tabs" role="tablist"><?php echo 
			            "<li class='active'><a href='profileauth.php?ip=" . $ip . "'>SSH-Auth</a></li>
					...
					<div class="content">
						<div id="ssh-auth">
							<table class="table table-striped">
								...
								<tbody>
									<?php
										$L = $kippo->getSumAuthByIP($ip);
										$num = $L->fetch_array();
										$total = $num[0];
										$row_per_page = 15;
										$lastpage = ceil($total/$row_per_page);
										$start = ($pageno - 1) * $row_per_page;
										$auth = $kippo->getAuthByIP($ip, $start, $row_per_page);
										$i = $start + 1;
										while ($row = $auth->fetch_array()){
											echo 	"<tr>
														<td>" . $i . ".</td>
														<td>" . $row['id'] . "</td>
														<td>" . $row['username'] . "</td>
							...
							<div class="text-center">
								<ul class="pagination">
									<?php
										$page->common('profileauth.php?ip', $ip, $pageno, $lastpage);
									?>
								</ul>
							</div>
						</div>
